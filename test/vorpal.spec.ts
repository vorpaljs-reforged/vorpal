...
describe('argument parsing', function() {
  ...
  it('should NOT normalize key=value pairs when isCommandArgKeyPairNormalized is false', function() {
    ...
    expect(obj(vorpal.execSync('multiple "hello=world" \'hello="world"\' "hello=`world`"'))).toBe(
      fixture
    );
...
describe('option parsing', function() {
  ...
  describe('options before an arg', function() {
    ...
    it('should accept a long optional option', function() {
      ...
      expect(obj(vorpal.execSync('foo --optional cheese bar smith'))).toBe(fixture);
    });
    ...
    it('should accept a long required option', function() {
      ...
      expect(obj(vorpal.execSync('foo --required cheese bar smith'))).toBe(fixture);
    });
  });
  ...
  describe('options after args', function() {
    ...
    it('should accept a long optional option', function() {
      ...
      expect(obj(vorpal.execSync('foo bar smith --optional cheese '))).toBe(fixture);
    });
    ...
    it('should accept a long required option', function() {
      ...
      expect(obj(vorpal.execSync('foo bar smith --required cheese '))).toBe(fixture);
    });
  });
